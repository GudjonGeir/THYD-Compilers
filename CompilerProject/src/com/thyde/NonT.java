...
public enum NonT {
  PROGRAM, VARIABLE_DECLARATIONS, TYPE, VARIABLE_LIST, VARIABLE_LIST_2, VARIABLE, VARIABLE2, METHOD_DECLARATIONS, MORE_METHOD_DECLARATIONS, METHOD_DECLARATION, METHOD_RETURN_TYPE, PARAMETERS, PARAMETER_LIST, PARAMETER_LIST2, STATEMENT_LIST, STATEMENT2, STATEMENT3, STATEMENT, OPTIONAL_EXPRESSION,STATEMENT_BLOCK,OPTIONAL_ELSE,EXPRESSION_LIST,MORE_EXPRESSIONS,EXPRESSION, EXPRESSION2, SIMPLE_EXPRESSION, SIMPLE_EXPRESSION2,TERM,TERM2,FACTOR2,FACTOR3,FACTOR,VARIABLE_LOC,VARIABLE_LOC2,SIGN;
